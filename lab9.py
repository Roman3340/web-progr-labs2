...
# @lab9.route('/lab9/congratulations', methods=['POST'])
# def congratulations():
...
#     # Определяем сообщение и картинку
#     if gender == 'male':
#         pronoun = 'ты быстро вырос, был умным и счастливым'
#     else:
#         pronoun = 'ты быстро выросла, была умной и счастливой'
